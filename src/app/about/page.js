...
export const metadata = {
  title: "About Us | Trove Experience",
};
...
export default function About() {
  return (
    <div className="w-full pt-32 pb-20 container mx-auto px-4 lg:max-w-7xl min-h-[60vh] flex flex-col items-center justify-center text-center">
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-primary tracking-tight" style={{ fontFamily: 'var(--font-playfair)' }}>About Trove Experience</h1>
