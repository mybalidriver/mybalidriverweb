  ...
  if (!user) {
     return (
        <div className="min-h-[100dvh] bg-white pb-32 font-sans flex flex-col items-center justify-center px-6 text-center">
           ...
           <p className="text-gray-500 font-medium mb-8 max-w-sm">Sign in with your Google account to view your upcoming and past bookings with My Bali Driver.</p>
           <button onClick={handleGoogleLogin} className="flex items-center justify-center gap-3 w-full max-w-xs bg-white border border-gray-200 text-primary font-bold py-4 rounded-full shadow-sm hover:bg-gray-50 transition-all active:scale-95">
                ...
                <div className="flex flex-col px-1">
                  ...
                  {activeTab === "upcoming" && (
                    <div className="mt-5 pt-4 border-t border-gray-100 flex gap-3">
                      <a 
                        href={`https://wa.me/6285174119423?text=${encodeURIComponent(`Hello My Bali Driver, regarding my booking:\n\n*MY BALI DRIVER BOOKING*\n\n*ID:* #${b.id}\n*TITLE:* ${b.service_name.toUpperCase()}\n*DATE:* ${b.booking_date}\n*PRICE:* ${b.amount}\n\nPlease assist me to confirm.`)}`} 
                        target="_blank" 
                        rel="noreferrer" 
